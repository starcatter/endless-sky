...
void ShipInfoDisplay::UpdateAttributes(const Ship &ship, const Depreciation &depreciation, int day)
{
	...
	attributeLabels.push_back("maintenance hours / crew:");
	attributeValues.push_back(Format::Number(ship.RequiredMaintenanceHours())
		+ " / " + Format::Number( ship.RequiredMaintenanceCrew() ));
	attributesHeight += 20;
